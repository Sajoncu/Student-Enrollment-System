...
<head>
  ...
  <!-- datatable -->
  <link rel="stylesheet" href="{{asset('/node_modules/dat/atables.net-bs4/css/dataTables.bootstrap4.css')}}" />
</head>
        ...
        <ul class="navbar-nav ml-lg-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              <a class="dropdown-item" href="{{URL::to('/student_profile',Session::get('student_id'))}}">
              ...
              <a class="dropdown-item" href="{{URL::to('/student_settings',Session::get('student_id'))}}">
                <div class="sender-img">
                  <img src="http://via.placeholder.com/47x47" alt="">
                  <span class="badge badge-success">&nbsp;</span>
                </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
            	@php
            		$image = Session::get('student_image');
            	@endphp
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('')}}">
                ...
                <span class="menu-title">Academic Transcript</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('')}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('E')}}">BSTE</a>
                  </li>                  
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/')}}">ETE</a>
                  </li>
                </ul>
              </div>
            </li> 
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="/">All Teacher</a>
                  </li>
{{--                   <li class="nav-item">
