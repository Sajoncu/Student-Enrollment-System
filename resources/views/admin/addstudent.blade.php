    ...
    <div class="col-lg-12 mb-4">
      <div class="card">
        <div class="card-body">
          ...
          <form class="cmxform" enctype="multipart/form-data" id="signupForm" method="post" action="{{ URL::to('/savestudent')}}">
          	{{csrf_field()}}
            <fieldset>
              <div class="form-group">
                <label for="student_name">Student Name</label>
                <input id="student_name" class="form-control" name="student_name" type="text">
              </div>
              <div class="form-group">
                <label for="student_roll">Student Roll</label>
                <input id="student_roll" class="form-control" name="student_roll" type="text">
              </div>              
              <div class="form-group">
                <label for="student_fathersname">Father's Name</label>
                <input id="student_fathersname" class="form-control" name="student_fathersname" type="text">
              </div>
              <div class="form-group">
                <label for="student_mothersname">Mother's Name</label>
                <input id="student_mothersname" class="form-control" name="student_mothersname" type="text">
              </div>
              <div class="form-group">
                <label for="student_email">Student Email</label>
                <input id="student_email" class="form-control" name="student_email" type="email">
              </div>
              <div class="form-group">
                <label for="student_password">Student Password</label>
                <input id="student_password" class="form-control" name="student_password" type="password">
              </div>
              <div class="form-group">
                <label for="student_phone">Student Phone</label>
                <input id="student_phone" class="form-control" name="student_phone" type="number">
              </div>              
              <div class="form-group">
